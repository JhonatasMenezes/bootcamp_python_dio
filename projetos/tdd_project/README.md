...
### Ciclo do TDD
![C4](https://github.com/digitalinnovationone/store_api/blob/main/docs/img/img-tdd.png)
...
### Arquitetura
|![C4](https://github.com/digitalinnovationone/store_api/blob/main/docs/img/store.drawio.png)|
|:--:|
| Diagrama de C4 da Store API |

### Banco de dados - MongoDB
|![C4](https://github.com/digitalinnovationone/store_api/blob/main/docs/img/product.drawio.png)|
|:--:|
| Database - Store API |
